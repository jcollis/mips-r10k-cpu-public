...
[![ETB Design](diagrams/etb-design.png)](diagrams/etb-design.pdf)
...
[![Memory Hierarchy](diagrams/mem-hierarchy.png)](diagrams/mem-hierarchy.pdf)

### Data Memory & LSQ Forwarding
...
[![LSQ Design](diagrams/lsq-design.png)](diagrams/lsq-design.pdf)
...
- `diagrams/` — Architecture diagrams and subsystem designs (ETB, LSQ, memory hierarchy, etc.)
